...
import Resume from '../assets/Madhan_Kumar_resume.pdf';
             ...
             <div className='text-center mt-20  flex flex-col md:flex-row items-center'>
              <div className='w-1/2 flex flex-col items-center text-center'>
               ...
               <p className='text-shadow-md md:w-80  text-center p-2 '> UI/UX Designer , Web developer & Flutter Developer building beautiful, functional apps.</p>
                 <a href={Resume} download="Madhan_Kumar_resume.pdf" className="inline-flex items-center gap-2 rounded-2xl bg-indigo-600 px-4 py-2 text-white font-semibold hover:bg-indigo-700 active:scale-95 transition mt-5" >Download My Resume</a>
              </div>
